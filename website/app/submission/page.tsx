        ...
        >
          ...
          <div className="grid md:grid-cols-4 gap-4">
            ...
            <div className="bg-secondary/20 border border-secondary/50 rounded-lg p-4 text-center">
              <div className="text-3xl font-bold text-secondary mb-2">54/54</div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div>
                ...
                <p className="text-slate-300">
                  ...
                  All 54 tests pass (22 local + 15 E2E + 10 devnet + 7 unit), covering quote-only validation,
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-slate-300">
                  54 total tests (22 local + 15 E2E + 10 devnet + 7 unit) with 100% pass rate. Tests cover
